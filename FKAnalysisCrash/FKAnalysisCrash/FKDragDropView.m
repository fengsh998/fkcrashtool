...
-(BOOL)prepareForDragOperation:(id<NSDraggingInfo>)sender{
    ...
    // 3）、将接受到的文件链接数组通过代理传送
    if(self.delegate && [self.delegate respondsToSelector:@selector(dragDropView:FileList:)])
        [self.delegate dragDropView:self FileList:list];
